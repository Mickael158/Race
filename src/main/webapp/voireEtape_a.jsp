        ...
        <div id="content">
            ...
            <div class="table-responsive p-3">
                    <table class="table align-items-center table-flush" id="dataTable">
                        ...
                        <form action="${pageContext.request.contextPath}/VoireEtape_a" method="post">
                        <tr>
                            <th><%= etape.getLieu() %></th>
                            <th><%= etape.getDepart() %></th>
                            <th><%= etape.getLongueur() %> km</th>
                            <th><%= etape.getNbr_Coureur_Equipe() %></th>
                            <th><input type="hidden" value="<%= etape.getIdEtape()%>" name="idetape"><button type="submit" class="btn btn-primary" >Temps</button></th>
                        </tr>
                        </form>
                        <%}%>
                        </tbody>
