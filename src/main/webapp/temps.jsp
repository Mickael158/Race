...
<%
    ...
    List<Coureur> coureurList = (List<Coureur>) request.getAttribute("coureurList_Composer");
%>
                ...
                <div class="col-lg-12">
                    <center>
                        <div class="card-body" >
                            ...
                            <form action="${pageContext.request.contextPath}/AddTepms" method="post">
                                <div class="form-group">
                                    <label >A prpos</label>
                                    <div class="row row-cols-1 row-cols-md-2">
                                        <div class="col" style="width: 30%">
                                            <p>Numero : </p><input class="form-control" list="coureurs"  style="text-align: center" name="numero">
                                            <datalist id="coureurs">
                                                <% for (Coureur coureur : coureurList){%>
                                                    <option value="<%= coureur.getNumero() %>"><%= coureur.getNumero()%></option>
                                                <%}%>
                                            </datalist>
                                        </div>
                                        <div class="col" style="width: 30%">
                                        ...
                                        <div class="col" style="width: 30%">
                                            <p>Debut : </p><input class="form-control" type="text" id="name-4" name="depart" style="text-align: center" value=" <%= etape.getDepart() %>" disabled>
                                        </div>
                                        <div class="col" style="width: 30%">
                                            <p>fin : </p><input class="form-control" type="datetime-local" id="name-3" name="fin" style="text-align: center" ><input class="form-control" type="number" id="name-2" name="seconde" style="text-align: center" placeholder="Seconde" >
                                        </div>
                                    </div>
                                </div>
                            <div class="col"><button type="submit" class="btn btn-primary">Enregistrer</button></div>
                            </form>
                            <%}%>
                        </div>
                    </center>
