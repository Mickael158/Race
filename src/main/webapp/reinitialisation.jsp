    ...
    <div id="content">
      ...
      <div class="container-fluid" id="container-wrapper">
        <div class="col-lg-12">
          <center>
            <div class="card-body" >
              <form action="${pageContext.request.contextPath}/Reinitialisation" method="post">
                <div class="form-group">
                  <label >Pour Reinitialiser la base</label>
                  <div class="row row-cols-1 row-cols-md-2">
                    <div class="col"><input class="form-control" type="hidden" id="name-5" name="reinitialisation" value="ok"></div>
                  </div>
                </div>
                <div class="col"><button type="submit" class="btn btn-primary">Reinitialisation</button></div>
              </form>
            </div>
          </center>
        </div>
        ...
        <div class="col-lg-12">
          <center>
            <div class="card-body" >
              <form action="${pageContext.request.contextPath}/Reinitialisation" method="post">
                <div class="form-group">
                  <label >Genere le categories des coureur</label>
                  <div class="row row-cols-1 row-cols-md-2">
                    <div class="col"><input class="form-control" type="hidden" id="name-5" name="generer" value="ok"></div>
                  </div>
                </div>
                <div class="col"><button type="submit" class="btn btn-primary">Genrer</button></div>
              </form>
            </div>
          </center>
        </div>
