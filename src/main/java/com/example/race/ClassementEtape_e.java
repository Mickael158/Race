...
@WebServlet(name = "ClassementEtape_e", value = "/ClassementEtape_e")
public class ClassementEtape_e extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("classementEtape_e.jsp").forward(request, response);
    }
